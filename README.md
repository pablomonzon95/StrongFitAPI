This is is an API REST created to be consumed by an fitness app. This app  different types of exercises and diets according to the users objective, equipment and age. 
